...
# ---- 3. simonpunk/susfs4ksu @ master (OLD API kernel fs patch ONLY) ----
echo "[SUSFS] Cloning simonpunk/susfs4ksu master..."
rm -rf "${SUSFS_SIM}"
git clone --depth=1 https://gitlab.com/simonpunk/susfs4ksu.git "${SUSFS_SIM}"

SUSFS_PATCH="${SUSFS_SIM}/kernel_patches/50_add_susfs_in_kernel-5.4.patch"
